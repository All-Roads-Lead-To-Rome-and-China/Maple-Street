...
const HomePage = () => {
  ...
  const services = [
    ...
    { title: "Suspension", img: suspensionImg, desc: "Smooth out your ride with suspension repairs." },
    { title: "Battery Service", img: batteryImg, desc: "Testing and replacement of car batteries." },
  ];
